...
<script>
	...
	<section class="mt-8 text-xl">
		<div class="container mx-auto px-3">
			<form action="modify" method="post" onsubmit="modifyForm_onSubmit(this); return false">
				...
				<div>
					<table class="table table-lg">
						...
						<tr>
							<th>제목</th>
							<td><input class="w-96" name="title" type="text" value="${article.id }" placeholder="제목을 입력해주세요."/></td>
						</tr>
						<tr>
							<th>내용</th>
