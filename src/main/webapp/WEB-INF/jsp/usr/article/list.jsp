		...
		<div class="mt-2 flex justify-center">
			<div class="join">
				...
				<c:if test="${from != 1 }">
					...
					<a class="join-item btn btn-square btn-sm" href="?boradId=${board.id } $page=${from - 1}">&lt;</a>
				</c:if>
				...
				<c:if test="${end != pagesCnt }">
					...
					<a class="join-item btn btn-square btn-sm" href="?boardId=${board.id} $page=${pageCnt }">&gt;&gt;</a>
				</c:if>
